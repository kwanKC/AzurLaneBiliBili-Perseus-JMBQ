...
#sed -ir "s#\($oncreate\)#.method protected onCreate(Landroid/os/Bundle;)V\n    .locals 2\n\n\1#" com.bilibili.AzurLane/smali_classes2/com/unity3d/player/UnityPlayerActivity.smali
sed -ir "/\($oncreate\)/{n;n;s//    const-string v0, \"JMBQ\"\n\n    invoke-static {v0}, Ljava\/lang\/System;->loadLibrary(Ljava\/lang\/String;)V\n\n/}" com.bilibili.AzurLane/smali_classes2/com/unity3d/player/UnityPlayerActivity.smali
grep -A5 $oncreate com.bilibili.AzurLane/smali_classes2/com/unity3d/player/UnityPlayerActivity.smali
